(defproject ticker "0.1.0-SNAPSHOT"
  ...
  :ring {:handler ticker.handler/app
         :uberwar-name "ticker.war"}
  :min-lein-version "2.5.0"
  :uberjar-name "ticker.jar"
  :main ticker.server
  ...
  :cljsbuild {:builds {:min {:source-paths ["src/cljs" "src/cljc" "env/prod/cljs"]
                       ...
                       :app {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                             :figwheel {:on-jsload "ticker.core/mount-root"}
                             :compiler {:main "ticker.dev"
                                        :asset-path "/js/out"
  ...
  :figwheel {:http-server-root "public"
             ...
             :ring-handler ticker.handler/app}
  :profiles {:dev {:repl-options {:init-ns ticker.repl
